...
[MarkdownExporter]
public static class BigOBenchmarks
{
    public readonly static List<int> OrderedNumbers = new()
    {
        1, 2, 4, 6, 10, 14, 15, 19, 20, 34, 36, 38, 40, 42, 50, 52, 55, 60, 61, 62, 63, 67, 70, 78, 80, 82, 84, 86, 88, 90, 92, 93, 99, 101, 105, 107, 110, 115,118
    };

    public readonly static List<int> UnorderedNumbers = new()
    {
